...
argumentos são mostrados no seguinte script. A primeira saída será -1
porque o texto de busca é ‘python’ e a variável texto não contém a string
‘Python’. A segunda saída retornará uma posição válida porque a palavra
‘program’ existe após a posição 10. A terceira saída retornará uma posição
válida porque a palavra ‘earn’ existe dentro do intervalo de 0 a 5 da string."""
